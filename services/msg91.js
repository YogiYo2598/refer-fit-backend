...
async function sendWhatsAppNotification({
  ...
  authkey = process.env.MSG91_AUTHKEY,
  integratedNumber = process.env.MSG91_INTEGRATED_NUMBER,
  templateName = process.env.MSG91_NOTIFICATION_TEMPLATE_NAME,
  languageCode = process.env.MSG91_LANG_CODE || "En",
}) {
  // Map your template components. Adjust keys to match your template exactly.
  // Your example used body_1 and button_1 (URL button). Reuse that:
        ...
        to_and_components: [
          {
            to: [to],
            components: {
              body_1: { type: "text", value: referrer },
              body_2: { type: "text", value: candidate },
              body_3: { type: "text", value: email },
              body_4: { type: "text", value: jobId },
              body_5: { type: "text", value: resumeURL },
            }
          }
        ]
      },
...
module.exports = { sendWhatsAppOtp, sendWhatsAppNotification };